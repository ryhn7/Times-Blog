...
@section('container')
                    ...
                    <div class="mb-5">
                        ...
                        <div class="grid grid-cols-1">
                            <div class="flex justify-start">
                                ...
                                @else
                                    <img src="https://source.unsplash.com/75x75?{{ $posts[0]->category->name }}"
                                        alt="image" class="rounded shadow-lg">
                                @endif
                            </div>
                            <div class="text-[#5A5A5A]">{{ $posts[0]->excerpt }}</div>
                            ...
                            <div class="w-full mb-2">
                                @if ($post->image)
                                    <img src="{{ asset('storage/' . $post->image) }}" alt="image"
                                        class="rounded shadow-lg" width="220px" height="150px">
                                @else
                                    <img src="https://source.unsplash.com/220x150?{{ $post->category->name }}"
                                        alt="image" class="rounded shadow-lg">
                                @endif
                            </div>
    ...
    @else
        <div class="max-w-full px-[450px] py-7">
            <div class="text-[28px] font-extrabold mb-3 font-franklin text-center">There are no post in this category yet</div>
